...
/// Trasforma una trascrizione grezza prima dell'inserimento nell'app attiva.
public protocol TextFormatter: Sendable {
    func format(_ raw: String) async -> String
}

/// Pulizia deterministica, locale e immediata per italiano e inglese.
public struct RuleBasedFormatter: TextFormatter {
    private static let fillers = ["um", "uh", "erm", "uhm", "hmm", "mhm", "ehm", "mmm"]
    ...
    public func format(_ raw: String) async -> String {
        ...
        return ensureTerminalPunctuation(in: text)
    }
